...
return (
    ...
    <div>
        <div className="profile-container" id="container">
            ...
            <div id='container2'>
          <form id="my-Form">
            <textarea type="text" name="SEARCH_VALUE" id='box' placeholder="Value" onChange={handleChange}/>
            <br/> 
            <textarea type="text" name="CATEGORY" id='box' placeholder="Category" onChange={handleChange2}/>
            <br/>  <br/>  <br/>  <br/>
            <input onClick={searching}  type="submit" value="Submit"  style={{ backgroundColor:"cyan"}} id='box'/>
          </form>
          </div>
